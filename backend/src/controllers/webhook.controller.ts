...
export class WebhookController {
    public static async handleOrderWebhook(req: Request, res: Response) {
        try {
    ...
    /**
     * Process order creation or update
     */
     ...
     */
    private static async processOrderCancellation(orderData: any) {
        try {
            await Order.findOneAndUpdate(
                { shopify_order_id: orderData.id.toString() },
                {
